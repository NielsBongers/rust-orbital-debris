...
impl Particle {
    ...
    pub fn particle_distance(&self, p2: &Particle) -> f64 {
        let r = ((p2.x - self.x).powf(2.0) + (p2.y - self.y).powf(2.0) + (p2.z - self.z).powf(2.0))
            .sqrt();
        return r;
    }
    ...
    pub fn write(&self, t: f64) {
        ...
        write!(
            file,
            "{}, {},{},{},{},{},{},{}\n",
            t, self.x, self.y, self.z, self.v_x, self.v_y, self.v_z, self.mass
        )
        .unwrap();
    }
}
